<p align="left"><img src="https://github.com/user-attachments/assets/d7f341ec-2906-4cf1-bf53-7cb670db2ab0" width="50" height="50"></p>
...
<style>
  ...
  .contenedor-flotante {
    ...
    top: 20%;        /* "Arribita de la mitad" */
    right: 120px;     /* Pegado al lado derecho con un pequeño margen */
    z-index: 10000;   /* Para que siempre esté por encima de otros elementos */
  }
